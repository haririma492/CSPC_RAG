...
def show_user_guide():
    """Small 'About CSPC AI Platform' chip on top-left, with proper rendered content."""
    ...
    <style>
      ...
      .cspc-about-content {
          ...
          border-radius: 10px;
          padding: 20px;
          max-width: 900px;      /* content width, not page width */
      }
    </style>
    ...
    # Small height → no huge gap; scrolling=True → content scrolls inside iframe
    components.html(html, height=130, scrolling=True)
